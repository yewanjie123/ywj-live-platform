package com.ywj.live.api.error;


import com.ywj.live.web.constants.ErrorAppIdEnum;
import com.ywj.live.web.error.BaseError;
...
public enum ApiErrorEnum implements BaseError {
    ...
    public int getErrorCode() {
        return Integer.parseInt(ErrorAppIdEnum.BMC_API_ERROR.getCode() + "" + errorCode);
    }
