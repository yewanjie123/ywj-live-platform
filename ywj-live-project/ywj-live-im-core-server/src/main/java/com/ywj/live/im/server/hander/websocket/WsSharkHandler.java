package com.ywj.live.im.server.hander.websocket;
...
import com.ywj.live.im.server.hander.impl.LoginMsgHandler;
...
public class WsSharkHandler extends ChannelInboundHandlerAdapter {
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest msg) {
        ...
        // String webSocketUrl = "ws://localhost:8086";
        // 构造握手响应返回
        ...
        if (channelFuture.isSuccess()) {
           /* Integer code = Integer.valueOf(paramArr[3]);
            ...
            //ImMsg imMsg = ImMsg.build(ImMsgCodeEnum.WS_SHARD_MSG.getCode(),"success");
